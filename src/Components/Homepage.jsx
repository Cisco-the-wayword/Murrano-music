    ...
    return (
        <main>
            ...
            <nav className="firth">
                <header>
                    <ul className="nav-links">
                        <li><a className="nav-link" href="https://google.com">Home</a></li>
                        <li><a className="nav-link" href="https://google.com">Services</a></li>
                        <li><a className="nav-link" href="https://google.com">Community</a></li>
                        <li><a className="nav-link" href="https://google.com">Read Music</a></li>
                        <li><a className="nav-link" href="https://google.com">Contact us</a></li>
                    </ul>
                </header>
                <section className="front-page">
                    ...
                    <div id="container">
                        <a className="head-button" href="https://google.com">PROMOTE MY MUSIC</a>
                        <a className="head-button" href="https://google.com">DISRIBUTE MY MUSIC</a>
                    </div>
                </section>
            </nav>
            <section className="action">
                ...
                <div className="row">
                    <div className="detail">
                        <p className="detail-text">Promote your music via different promotional routes and introduce your music
                ...
                <div className="row">
                    ...
                    <div className="detail">
                        ...
                        <div className="detail-button"> <a className="head-button" href="https://google.com">RECORD MY MUSIC</a> </div>
                    </div>
                </div>
                <div className="row">
                    <div className="detail">
                ...
                <div className="row">
                    ...
                    <div className="detail">
                        ...
                        <form method="post" className="form-data" id="formspree" action="https://formspree.io/f/mqkoovkd">
                            <fieldset>
                                <label>
